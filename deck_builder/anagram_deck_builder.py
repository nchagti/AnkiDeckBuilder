...
def control_buttons():
    return """
    <div class="controls">
    <button class="ctrl-btn" id="shuffleBtn" onclick="shuffleTiles()" title="Shuffle: j">
    ...
    <button class="ctrl-btn" id="resetBtn" onclick="resetTiles()" title="Reset: k">
    ...
    <button class="ctrl-btn" id="hintBtn" onclick="nextHint()" title="Hint: l">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" fill="currentColor">
